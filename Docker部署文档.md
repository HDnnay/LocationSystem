...
# 创建项目目录结构
RUN mkdir -p LocationSystem.Api LocationSystem.Application LocationSystem.Domain LocationSystem.Infrastructure LocationSystem.Presentation
...
COPY LocationSystem.Presentation ./LocationSystem.Presentation
