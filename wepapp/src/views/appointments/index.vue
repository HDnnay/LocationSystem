...
export default {
    ...
    data() {
        return {
            ...
            dentists: ['张医生', '李医生', '王医生', '赵医生', '孙医生'],
            // Dental office list (for dropdown)
            dentalOffices: ['中心牙科诊所', '东方牙科诊所', '南方牙科诊所', '西方牙科诊所', '北方牙科诊所'],
            // 预约列表
            appointments: [
                { id: 'A001', patientName: '患者A', dentistName: '张医生', dentalOffice: '中心牙科诊所', appointmentDate: '2025-01-15', appointmentTime: '09:30', status: 'completed', description: '常规检查' },
                { id: 'A002', patientName: '患者B', dentistName: '李医生', dentalOffice: '东方牙科诊所', appointmentDate: '2025-01-15', appointmentTime: '10:00', status: 'pending', description: '补牙' },
                { id: 'A003', patientName: '患者C', dentistName: '王医生', dentalOffice: '南方牙科诊所', appointmentDate: '2025-01-16', appointmentTime: '14:00', status: 'pending', description: '洗牙' },
                { id: 'A004', patientName: '患者D', dentistName: '赵医生', dentalOffice: '西方牙科诊所', appointmentDate: '2025-01-17', appointmentTime: '15:30', status: 'completed', description: '拔牙' },
                { id: 'A005', patientName: '患者E', dentistName: '孙医生', dentalOffice: '北方牙科诊所', appointmentDate: '2025-01-18', appointmentTime: '11:00', status: 'cancelled', description: '根管治疗' }
            ],
            // 分页
            currentPage: 1,
            pageSize: 10,
    ...
    methods: {
        ...
        handleSave() {
            ...
            this.$message.success(this.isEdit ? '预约更新成功' : '预约添加成功')
        },
        // 删除预约
        handleDelete(id) {
